...
export const html2 = (titulo, mensaje, button) => {
  let a = button.link
    ? `<a href="${button.link}"><button>${!button.text && "Click here"}</button></a>`
    : "<p></p>";
  return `<img style="background: black; display: block; width:400px; height: 152px;" src="https://i.postimg.cc/x8y022Hb/adoptame-logo-resplandor.png" alt="logo"><h1>${titulo}</h1><p>${mensaje}</p>${a}`
}